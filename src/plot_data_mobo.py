...
a variety of figures for the data. In its unmodified state, it will plot Fig. 2
of the cited paper as well as the trajectories of the simulation data stored in
the published results. Modifications to the settings of this code may be done to
achieve different visualizations of the data.
THIS SCRIPT WORKS FOR MULTI-OBJECTIVE BAYESIAN OPTIMIZATION TRIALS ONLY
...
plot_individual_trial_trajectories = False # [True/False] whether or not to plot all of the trajectories of a trial
plot_individual_trial_pareto = False # [True/False] whether or not to plot the Pareto plots for each trial individually
plot_hypervolume = True # [True/False] whether or not to plot the hypervolume improvement figure
save_figs = True # [True/False] whether or not to save the figures generated by this code
...
# file name of the folder containing the results to be plotted
date = '2022_09_16_13h47m02s'


# CHANGE TO VALUES USED IN SIMULATION/EXPERIMENT
n_mc = 5 # number of Monte Carlo replicates of the BO
n_cl_runs = 50+1 # number of closed-loop runs/iterations of BO
Nreps_per_iteration = 3 # number of replicates per iteration of BO
prob_info2 = get_prob_info(Kcem=0.55,Tmax=44.5) # patient

n_ste = 2 # number of standard errors to plot around the mean/average
...
import os
fig_save_folder = f'./saved/{date}-results/'
